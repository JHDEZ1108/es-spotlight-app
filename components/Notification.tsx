...
export default function NotificationItem ({notification, theme, styles } : { notification: any, theme: ThemeColors, styles: any }){
  return (
          ...
          <TouchableOpacity style={styles.avatarContainer}>
            ...
            <View style={styles.iconBadge}>
              {notification.type === "like" ? (
                <Ionicons name="heart" size={14} color={theme.secondary} />
